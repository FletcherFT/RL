...
def main(env_name, num_episodes, gamma, lam, kl_targ, batch_size, hid1_mult, policy_logvar):
    ...
    polwriter = tf.summary.FileWriter("./tmp/log", policy.g)
    valwriter = tf.summary.FileWriter("./tmp/log", val_func.g)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', '--env_name', type=str, help='AUVSim-v0', default='AUVSim-v0')
